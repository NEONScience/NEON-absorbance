...
#' (SUVA) at 350 nm from National Ecological Observatory Network (NEON) water
#' chemistry data.
...
#' @return This function returns a table of SUVA350 values
